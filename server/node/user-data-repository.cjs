...
const { DIRECTORY_INDEX, validateDirectoryMapping, createCharacterDirectoryResolver } = require('./character-directories.cjs');
const { planDirectoryMapping } = require('./friendly-paths.cjs');
