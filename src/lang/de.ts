...
export const languageGerman = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Dies kann ein CORS-Fehler sein. Dies geschieht nur bei Verwendung der Webversion aufgrund von Browserbeschränkungen. Versuchen Sie, die lokale Desktop-Version oder eine andere Version von RisuBard zu verwenden.",
    ...
    "setup": {
        ...
        "welcome": "Willkommen bei RisuBard! Ich bin Airisu und werde Sie durch die Einrichtung von RisuBard führen. Zuerst, wie darf ich Sie nennen?",
    ...
    "officialWikiDesc": "Offizielles Wiki für RisuBard. Schauen Sie doch gerne bei uns vorbei",
    "officialDiscord": "Offizieller Discord",
    "officialDiscordDesc": "Offizieller Discord zum Austausch über RisuBard",
    "persona": "Mein Profil",
    "icon": "Symbol",
    "account": "Konto",
    "remove": "Entfernen",
    ...
    "risupresetDesc": "Risupreset-Format ist ein Format, das speziell für RisuBard-Voreinstellungen entwickelt wurde.",
    "risuMDesc": "RisuM-Format ist ein Format, das speziell für RisuBard-Module entwickelt wurde.",
    ...
    "pluginVersionWarn": "Dies ist Version {{plugin_version}} des Plugins, die nicht mit dieser Version von RisuBard kompatibel ist. Bitte aktualisieren Sie das Plugin auf Version {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuBard hat Code erkannt, der schädlich sein könnte und IHREN API-SCHLÜSSEL ODER PERSÖNLICHE DATEN STEHLEN KANN. Wir empfehlen Ihnen, DIESES PLUGIN NICHT ZU INSTALLIEREN.",
    "doNotInstall": "Nicht installieren",
    "continueAnyway": "Trotzdem fortfahren",
    "pluginNoRiskButAlert": "RisuBard hat keinen schädlichen Code erkannt, aber beachten Sie bitte, dass die Installation von Plugins aus nicht vertrauenswürdigen Quellen Sicherheitsrisiken bergen kann.",
    ...
    "inlayPermissionConsent": "Plugin {} möchte eingebettete Assets lesen, die Chat-Nachrichten beigefügt sind. Möchten Sie dies zulassen?",
