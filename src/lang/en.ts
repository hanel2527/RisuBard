...
export const languageEnglish = {
    ...
    chatAutoTranslation: "Auto-translate character messages in this chat only",
    chatAutoTranslationOn: "Auto-translation is on for this chat. User messages and input are translated only manually.",
    chatAutoTranslationOff: "Auto-translation is off for this chat. Use Translate on a message or Translate Input.",
    ...
    sessionSavePausedTitle: "Saving paused because another tab or device is in use",
    sessionSavePausedDetail: "Recent chats and edits may exist only in this window. This page will not reload automatically. Download unsaved edits as JSON or copy the chats you need first. The download is not a full backup. Cancel keeps this window open; changes will not be saved to the server until you reload.",
    sessionReloadLatest: "Reload the latest server data",
    sessionReloadConfirm: "Discard this window's unsaved chats and edits and reload? Make sure you have downloaded or copied anything you need.",
    sessionReloadBusy: "A response or save is still in progress. Once it finishes or stops, return to this window to choose reload again.",
    ...
    chatSendPreparing: "Preparing to send...",
    chatSendBusy: "Waiting for the current response to finish",
    chatSendSelectionChanged: "The selected conversation changed while preparing to send. Please send again in the intended conversation.",
    chatSendSyncTimeout: "File synchronization took longer than 30 seconds. Check the server connection and try sending again.",
    messageBodySize: "Body size",
    messageStoredSize: "Total message size",
    messageSizeHelp: "UTF-8 bytes. The total includes JSON formatting, prompts, translation records and recovery data. It is not the number of tokens sent to the model.",
