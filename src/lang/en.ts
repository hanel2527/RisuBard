...
export const languageEnglish = {
    ...
    lorebookWorkspace: {
        ...
        bardLoreDescription: "Grimoire preserves the legacy copy and injects only entries selected under a fixed budget.",
        ...
        bardAnalysisSettings: "AI analysis limits",
        bardAnalysisBatchEntries: "Entries per analysis batch",
        bardAnalysisInputTokens: "Analysis input-token limit",
        bardAnalysisOutputTokens: "Analysis output-token limit",
        bardAnalysisLinkedDepth: "Connected analysis depth",
        bardAnalysisTemperature: "Analysis temperature",
        bardAnalysisSettingsHint: "Saved to this character. Numeric fields have no hidden app maximum.",
        ...
        bardActivationHelp: "Choose whether this entry is always required, selected by a direct key or alias, retrieved by relevance, or excluded from automatic injection.",
        bardRequired: "Required",
        bardKeyed: "Key or alias match",
        bardRetrieve: "Relevant retrieval",
        bardNever: "Never inject",
        bardGuideTitle: "Grimoire help",
        bardGuideOpen: "Open Grimoire help",
        bardGuideIntro: "Grimoire keeps the original lorebook intact and selects only useful lore under a fixed budget. Retrieval runs locally and does not call an AI model during generation.",
        ...
        bardGuideRetrieveBody: "Selected when relevance search across the entry metadata and body clears the configured score threshold.",
        ...
        bardGuideCompatibilityBody: "The legacy lorebook remains the compatible source copy. Grimoire edits do not overwrite it. Metadata export/import transfers the Grimoire overlay, while cleanse removes only that overlay and preserves the legacy lorebook.",
        bardKind: "Lore kind",
        ...
        bardAnalysisEstimateNotice: (count: number) => `This will send ${count} model requests. The input estimate is calculated from the actual batch prompts; provider billing may differ.`,
