...
export const languageEnglish = {
    ...
    risuBardMemoryForceUpdate: "Batch analysis",
    risuBardMemoryForceUpdating: "Batch-analyzing unconfirmed turns...",
    risuBardMemoryForceUpdateDone: "Batch analysis completed.",
    risuBardMemoryForceUpdateMeta: (turn: number, time: string) => `Analyzed through AI turn ${turn.toLocaleString()} · Updated: ${time}`,
    risuBardMemoryForceUpdateEmpty: "There are no AI responses to analyze.",
    risuBardMemoryForceUpdateFailed: "Batch analysis failed. Check the activity log.",
