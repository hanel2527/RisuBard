...
export const languageSpanish = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Esto puede ser un error de CORS. Esto solo ocurre al usar la versión web debido a las limitaciones del navegador. Intenta usar la versión local de escritorio u otra versión de RisuBard.",
    ...
    "setup": {
        ...
        "welcome": "¡Bienvenido a RisuBard! Aquí te guiaré para configurarlo. Primero, ¿cómo puedo llamarte?",
    ...
    "officialWikiDesc": "Wiki Oficial de RisuBard. siéntete libre de consultarla.",
    "officialDiscord": "Discord Oficial",
    "officialDiscordDesc": "Discord Oficial para hablar sobre RisuBard",
    "persona": "Persona",
    "icon": "Icono",
    "account": "Cuenta",
    "remove": "Eliminar",
    ...
    "risupresetDesc": "El formato Risupreset es un formato específicamente diseñado para presets de RisuBard.",
    "risuMDesc": "El formato RisuM es un formato diseñado específicamente para módulos de RisuBard.",
    ...
    "pluginVersionWarn": "Esta es la versión {{plugin_version}} del plugin, que no es compatible con esta versión de RisuBard. Por favor, actualiza el plugin a la versión {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuBard detectó código que puede ser dañino y que podría ROBAR TU CLAVE API O DATOS PERSONALES. te recomendamos NO INSTALAR ESTE PLUGIN.",
    "doNotInstall": "No Instalar",
    "continueAnyway": "Continuar de Todos Modos",
    "pluginNoRiskButAlert": "RisuBard no detectó código dañino, pero ten en cuenta que instalar plugins de fuentes no confiables puede plantear riesgos de seguridad.",
