...
export const languageKorean = {
  ...
  risuBardMemoryForceUpdate: "Batch 분석",
  risuBardMemoryForceUpdating: "미확정 턴 Batch 분석 중...",
  risuBardMemoryForceUpdateDone: "Batch 분석을 완료했습니다.",
  ...
  risuBardMemoryForceUpdateFailed: "Batch 분석에 실패했습니다. 작업 로그를 확인하세요.",
