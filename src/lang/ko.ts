...
export const languageKorean = {
  ...
  chatAutoTranslation: "이 채팅에서만 캐릭터 메시지 자동 번역",
  chatAutoTranslationOn: "이 채팅의 자동 번역이 켜져 있습니다. 사용자 메시지와 입력은 수동으로만 번역됩니다.",
  chatAutoTranslationOff: "이 채팅의 자동 번역이 꺼져 있습니다. 메시지 번역 또는 입력창 번역하기를 사용하세요.",
  fullscreen: "전체화면(비권장)",
