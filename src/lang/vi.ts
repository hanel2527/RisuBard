...
export const languageVietnamese = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "This can be a CORS error. this only happens when using web version dude to limitations of the browser. try using desktop local version, or other version of RisuBard.",
    ...
    "setup": {
        ...
        "welcome": "Chào mừng đến với RisuBard! Tôi là Airisu, tôi ở đây để hướng dẫn bạn cài đặt RisuBard. Trước tiên, tôi có thể gọi bạn là gì?",
    ...
    "officialWikiDesc": "Wiki chính thức của RisuBard. cứ thoải mái xem nhé.",
    "officialDiscord": "Bất hòa chính thức",
    "officialDiscordDesc": "Discord chính thức nói về RisuBard",
    "persona": "nhân cách",
    "icon": "Biểu tượng",
    "account": "Tài khoản",
    "remove": "Di dời",
    ...
    "risupresetDesc": "Định dạng Risupreset là định dạng được thiết kế dành riêng cho các cài đặt trước RisuBard.",
    "risuMDesc": "Định dạng RisuM là định dạng được thiết kế dành riêng cho các mô-đun RisuBard.",
    ...
    "pluginVersionWarn": "Đây là phiên bản {{plugin_version}} của plugin, không tương thích với phiên bản RisuBard này. Vui lòng cập nhật plugin lên phiên bản {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuBard phát hiện mã có thể gây hại, có thể ĂN CẮP KHÓA API HOẶC DỮ LIỆU CÁ NHÂN CỦA BẠN. Chúng tôi khuyên bạn KHÔNG NÊN CÀI ĐẶT PLUGIN NÀY.",
    "doNotInstall": "Không cài đặt",
    "continueAnyway": "Vẫn tiếp tục",
    "pluginNoRiskButAlert": "RisuBard không phát hiện mã độc hại, nhưng xin lưu ý rằng việc cài đặt plugin từ các nguồn không tin cậy có thể gây rủi ro bảo mật.",
    ...
    "inlayPermissionConsent": "Plugin {} đang yêu cầu quyền đọc tài nguyên đính kèm trong tin nhắn trò chuyện. Bạn có muốn cho phép không?",
